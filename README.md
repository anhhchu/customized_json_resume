This repo is the extension of Kelyvin's [jsonresume-theme-caffeine](https://github.com/kelyvin/jsonresume-theme-caffeine). I update this repo to host my own resume on firebase. 

Follow the initial project's README, ensure you have Node v12 installed. Follow below instruction to 

### 1. Install Node v12

  `nvm install v12.14.1`

  Make sure to check node version before running `npm start`
...
? Select a default Firebase project for this directory: resume-anhcodes (resume-anhcodes)
i  Using project resume-anhcodes (resume-anhcodes)
